import { languages, isMethodSupportedForLanguage, REQUIRES_EXPLICIT_SOURCE } from "./languages-data.js";
import { findMethodLabel } from "./registry.js";
import type { TranslationMethod } from "./types.js";
...
export const splitTextIntoLines = (text: string): string[] => text.split(/\r?\n/);
