...
import type { TranslationService } from "@subtitle-translator/translation-core";
import { defaultConfigs, getLanguageName, isMethodSupportedForLanguage } from "@subtitle-translator/translation-core";
import { fetchJSON, formatHttpError, parseRetryAfterMs, requireApiKey, requireUrl, completeOpenAICompatUrl, PROXY_ENDPOINTS, THIRD_PARTY_ENDPOINTS, getOpenAICompatContent } from "./shared.js";
